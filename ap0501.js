...
function init() {
  ...
  const texture1 = texttureLoader.load("logo.png");
  const texture2 = texttureLoader.load("myPict.png");
  ...
  // 自動販売機の作成
  // 素材に関する処理
  const venderTexture01 = texttureLoader.load("vender01.jpg");
  const venderTexture02 = texttureLoader.load("vender02.jpg");
